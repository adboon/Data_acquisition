...
If you want to have a list of nomenclature you use in your thesis, use the \texttt{nomencl} package. I want \(\beta\)\nomenclature{\(\beta\)}{Second letter of Greek alphabet} to be listed, as well as \(a\)\nomenclature{\(a\)}{First letter of Latin alphabet}. These should be printed in the order in which they come. 
